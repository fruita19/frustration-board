...
function MatchView({ router, matchId, resetKey, matchState }) {
	...
	}), matchState.parentRouteId === "__root__" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(OnRendered, { resetKey }), router.options.scrollRestoration && true ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScrollRestoration$1, {}) : null] }) : null] });
}
...
//#endregion
export { rootRouteId as C, decodePath as D, invariant as E, require_react as O, isResolvedRedirect as S, createLRUCache as T, getStylesheetHref as _, RouterProvider as a, executeRewriteInput as b, lazyRouteComponent as c, Link as d, require_jsx_runtime as f, createInlineCssStyleAsset as g, createInlineCssPlaceholderAsset as h, ScrollRestoration as i, createFileRoute as l, TSR_SCRIPT_BARRIER_ID as m, Scripts as n, createRouter as o, GLOBAL_TSR as p, HeadContent as r, Outlet as s, renderRouterToStream as t, createRootRoute as u, isInlinableStylesheet as v, isNotFound as w, isRedirect as x, resolveManifestAssetLink as y };
